...
(function () {
  ...
  var filelistx = Number(parameters["FileListWindowX"] || 24);
  var filelisty = Number(parameters["FileListWindowY"] || 96);
  var filelistwidth = Number(parameters["FileListWindowWidth"] || 120);
  var filelistheight = Number(parameters["FileListWindowHeight"] || 420);
  ...
  var filestatusx = Number(parameters["FileStatusWindowX"] || 200);
  var filestatusy = Number(parameters["FileStatusWindowY"] || 96);
  var filestatuswidth = Number(parameters["FileStatusWindowWidth"] || 400);
  var filestatusheight = Number(parameters["FileStatusWindowHeight"] || 420);
  var filestatusop = Number(parameters["FileStatusWindowOp"] || 255);

  var mapheader = String(parameters["MapPlaceHeader"]);
  var moneyheader = String(parameters["MoneyHeader"]);
  var nodatatext = String(parameters["NoDataText"]);

  var param_ADVN = PluginManager.parameters("TA_AdventureNote");
  var ADVNison = Object.keys(param_ADVN).length > 0;
  var mevbase = (param_ADVN["MainEvents"]);
  var mainevent = StructConvert(mevbase);
  var metv = Number(param_ADVN["MainEventVariable"]);
  ...
  Scene_File.prototype.createStatusWindow = function () {
    var x = filestatusx;
    var y = filestatusy;
    var width = filestatuswidth;
    var height = filestatusheight;
