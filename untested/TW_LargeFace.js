...
(function () {
  ...
  var lfacel = String(parameters["LargeFaceLetter"] || "_L");
  var lfacew = Number(parameters["LargeFaceWidth"] || 144);
  var lfaceh = Number(parameters["LargeFaceHeight"] || 144);

  Window_Message.prototype.drawFace = function(faceName, faceIndex, x, y, width, height) {
    width = width || lfacew;
    height = height || lfaceh;
    var bitmap = ImageManager.loadFace(faceName + lfacel);
    var pw = lfacew;
    var ph = lfaceh;
