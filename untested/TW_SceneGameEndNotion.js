...
(function () {
  ...
  var enwx = Number(parameters["EndNotionWindowX"] || 0);
  var enwy = Number(parameters["EndNotionWindowY"] || 0);
  var enwwidth = Number(parameters["EndNotionWindowWidth"] || 816);
  var enwheight = Number(parameters["EndNotionWindowHeight"] || 72);
  var enwop = Number(parameters["EndNotionWindowOp"] || 255);
  var enwbg = String(parameters["EndNotionWindowBG"]);
  var entfs = Number(parameters["EndNotionTextFontSize"] || 28);
  var etxt = String(parameters["EndNotiontext"]);
  ...
  Window_EndNotion.prototype.refresh = function () {
    this.contents.clear();
    if (enwbg) {
      var bitmap = ImageManager.loadSystem(enwbg);
  ...
  Scene_GameEnd.prototype.createEndNotionWindow = function () {
    ...
    this._EndNotionnameWindow = new Window_EndNotion();
