 ...
 * @desc メニューインデックスの塗りつぶし領域の色を設定します。
 * @default 0, 0, 0, 0.4
 * @parent MenuIndexBackground
 * 
 * @param MenuIndexSkin
 * @desc 各メニューインデックスのスキンファイルです。
 * @type file
 * @require 1
 * @dir img/system
 * @default
...
(function () {
  ...
  var stmems = Number(parameters["StatusMembers"] || 4);

  var rsvmcolor = String(parameters["ReserveMemberColor"] || "0, 0, 0, 0.4");
