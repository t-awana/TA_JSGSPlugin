...
(() => {
  ...
  Window_MenuStatus.prototype.drawItemBackground = function (index) {
    ...
    if (!actor.isBattleMember()) {
      var resvsprite = new Sprite(new Bitmap(w, h));
      resvsprite.bitmap.fillRect(0, 0, w, h, this.ReserveColor());
      this._textureBGSprites.addChild(resvsprite);
    }
  ...
  Window_MenuStatus.prototype.drawItemImage = function (index) {
    ...
    if (actor.meta.MenuPortrait) {
      portrait = ImageManager.loadFace(actor.meta.MenuPortrait);
      portraitbitmap = portrait.bitmap;
    width = portraitbitmap.width;
    height = rect.height - 2;
      this.contents.blt(portrait, rect.x + 1, rect.y + 1, 0, 0, width, height);
    } else {
